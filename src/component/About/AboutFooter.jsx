...
const AboutFooter = () => {
  ...
  <div className="absolute inset-0 bg-black/50   backdrop-blur-sm z-[-1] "></div> {/* 🔹 dark overlay for readability */}
  ...
  <div className="container mx-auto px-6 md:px-20 relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-800 pb-8">
      ...
      <div>
        ...
        <ul className="space-y-2 pl-4 md:pl-0 text-sm">
          ...
          <li><Link to="/oss" className="hover:text-pink-400">onsitesupportservicesoss</Link></li>
          <li><Link to="/launguage" className="hover:text-pink-400">languageinterpretation</Link></li>
        </ul>
      </div>
    ...
    <div className="text-center pb-10 text-xs md:pb-5 text-white mt-4">
      © 2025 Created with{" "}
      <a href="https://amigowebster.com" target="_blank" className="text-white px-2 text-[13px] font-bold hover:underline">amigowebster</a>
    </div>
  </div>
